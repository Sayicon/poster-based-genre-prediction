...
Tablo~\ref{tab:models} beş modelin sonuçlarını v1 referansları ve rasgele
...
\toprule
\textbf{Model} & \textbf{Makro F1} & \textbf{Mikro F1} & \textbf{Makro AUC} & \textbf{Prec.} & \textbf{Rec.}\\
\midrule
\textbf{Swin} & \textbf{0,562} & 0,566 & 0,862 & 0,541 & 0,587\\
